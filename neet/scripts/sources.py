...
GCS layout (mirrors nmc/):
    gs://avantifellows-external-data/neet/raw/<pdf>              (traceability)
    gs://avantifellows-external-data/neet/raw/mizoram-zmch-2025-admitted/<png>
    gs://avantifellows-external-data/neet/extracted/<csv>        (parser output)
    gs://avantifellows-external-data/neet/clean/<table>.parquet  (loaded to BQ)
"""
