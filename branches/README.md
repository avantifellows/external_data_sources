...
every branch/programme string in our 14 cutoff sources to it. This is the
join that lets "CSE" mean one thing across JoSAA, KCET, WBJEE, OJEE,
MHT-CET, the EAPCETs, GUJCET, TNEA, KEAM, CLAT, NEET, JAC Chandigarh and the fees sheet —
...
- **`external_data_sources.exam_branch_mapping`** (1,613 rows) — one row
