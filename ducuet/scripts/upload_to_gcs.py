#!/usr/bin/env python3
"""
Upload DU CUET cutoffs data to GCS.

Uploads (mirrors the moe/ convention):
  - Raw:   the 3 source round PDFs, as-is (they ARE the raw artifact)
           gs://avantifellows-external-data/ducuet/raw/<pdf>
...
Run build_clean.py first to produce clean/ducuet_fact_cutoffs.parquet.
