...
| AISHE (India) | [`aishe/`](aishe/) | Active | All India Survey on Higher Education (MoE). Two pipelines: (1) HE Directory — live directory of all HE institutions (colleges, universities, standalone, R&D, PM Vidyalaxmi) → 5 `aishe_dim_*` tables; (2) Student enrolment + graduates from Final Report workbooks (Tables 33, 34a, 12+35) → 1 `aishe_fact_higher_ed_students` table. |
