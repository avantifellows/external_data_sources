...
| AISHE (India) | [`aishe/`](aishe/) | Active | All India Survey on Higher Education (MoE) — student enrolment + graduates (out-turn) from AISHE Final Report workbooks. Three cuts: state×level (Table 33), programme×social category (Table 34a), UG discipline trend 2019-22 (Tables 12+35). xlsx parse → GCS → BQ. → 1 table: `aishe_fact_higher_ed_students`. |
