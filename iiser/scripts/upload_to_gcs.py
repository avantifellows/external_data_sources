#!/usr/bin/env python3
"""
Upload IISER closing ranks data to GCS.
...
Uploads (mirrors the moe/ convention):
  ...
  - Clean: the parsed fact → parquet
           gs://avantifellows-external-data/iiser/clean/iiser_fact_cutoffs.parquet
           (this is what load_bq.py loads)

Run build_clean.py first to produce clean/iiser_fact_cutoffs.parquet.
