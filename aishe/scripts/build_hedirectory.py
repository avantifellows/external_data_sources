...
Usage:
  python3 scripts/build_hedirectory.py                              # all five tables
  python3 scripts/build_hedirectory.py --table aishe_fact_colleges  # one only
  python3 scripts/build_hedirectory.py --dry-run                    # print stats, no write
"""
...
from sources_hedirectory import CLEAN, TABLE_BY_NAME, TABLES, Table
