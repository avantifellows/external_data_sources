...
Usage:
  python3 scripts/load_hedirectory_bq.py                              # load all five
  python3 scripts/load_hedirectory_bq.py --table aishe_fact_colleges  # one only
  python3 scripts/load_hedirectory_bq.py --dry-run                    # print plan, no BQ writes
"""
...
from sources_hedirectory import BQ_DATASET, BQ_LOCATION, BQ_PROJECT, TABLE_BY_NAME, TABLES, Table
